function OtherBrowser() {
	...
	//Filter list is document.createElement(option) then innerHTML for Other...
...
OtherBrowser.prototype.Load = function () {
	this.MainWindow.appendChild(this.Container);
}

OtherBrowser.prototype.GenerateLayout = function() {
	...
	this.DownloadButton.innerHTML = "Download Other";
...
OtherBrowser.prototype.UploadButtonPress = function(evt) {
...
OtherBrowser.prototype.create = function(obj, func){
    var f = function(){
...
OtherBrowser.prototype.DownloadButtonPress = function(evt) {
...
OtherBrowser.prototype.SearchButtonPress = function(evt) {

	this.OtherBrowserMaker(this.SearchBar.value);
	
}


OtherBrowser.prototype.AppendButtons = function() {
...
OtherBrowser.prototype.ReturnButtonPress = function() {
	MainWindow.removeChild(OtherBrowserDiv.Container);
	MainWindow.appendChild(MainMenuDiv.Load());
}

OtherBrowser.prototype.OtherBrowserMaker = function(string_SearchParamater) {
	...
	this.Table = new Table("OtherTable");
