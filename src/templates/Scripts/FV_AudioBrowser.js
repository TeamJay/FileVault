...
AudioBrowser.prototype.GenerateLayout = function() {
	...
	this.DownloadButton.innerHTML = "Download Audio";
...
AudioBrowser.prototype.UploadButtonPress = function(evt) {
...
AudioBrowser.prototype.create = function(obj, func){
    var f = function(){
...
AudioBrowser.prototype.DownloadButtonPress = function(evt) {
...
AudioBrowser.prototype.SearchButtonPress = function(evt) {

	this.AudioBrowserMaker(this.SearchBar.value);
	
}


AudioBrowser.prototype.AppendButtons = function() {
...
AudioBrowser.prototype.ReturnButtonPress = function() {
	MainWindow.removeChild(AudioBrowserDiv.Container);
	MainWindow.appendChild(MainMenuDiv.Load());
}

AudioBrowser.prototype.AudioBrowserMaker = function(string_SearchParamater) {
	...
	this.Table = new Table("AudioTable");
