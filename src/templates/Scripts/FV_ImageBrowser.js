...
ImageBrowser.prototype.Load = function () {
	this.MainWindow.appendChild(this.Container);
}

ImageBrowser.prototype.GenerateLayout = function() {
...
ImageBrowser.prototype.UploadButtonPress = function(evt) {
...
ImageBrowser.prototype.create = function(obj, func){
    var f = function(){
...
ImageBrowser.prototype.DownloadButtonPress = function(evt) {
...
ImageBrowser.prototype.SearchButtonPress = function(evt) {

	this.ImageBrowserMaker(this.SearchBar.value);
	
}


ImageBrowser.prototype.AppendButtons = function() {
...
ImageBrowser.prototype.ReturnButtonPress = function() {
	MainWindow.removeChild(ImageBrowserDiv.Container);
	MainWindow.appendChild(MainMenuDiv.Load());
}

ImageBrowser.prototype.ImageBrowserMaker = function(string_SearchParamater) {
	...
	this.Table = new Table("ImageTable");
